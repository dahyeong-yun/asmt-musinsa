...
public class PriceAnalysisAcceptanceTest extends AbstractAcceptanceTest {
    ...
    private final String 브랜드_A_명 = "A";
    private final String 브랜드_B_명 = "B";
    private final String 브랜드_C_명 = "C";
    private final String 브랜드_D_명 = "D";
    private final String 브랜드_E_명 = "E";
    private final String 브랜드_F_명 = "F";
    private final String 브랜드_G_명 = "G";
    private final String 브랜드_H_명 = "H";
    private final String 브랜드_I_명 = "I";

    private String 브랜드_A_ID;
    private String 브랜드_B_ID;
    private String 브랜드_C_ID;
    private String 브랜드_D_ID;
    private String 브랜드_E_ID;
    private String 브랜드_F_ID;
    private String 브랜드_G_ID;
    private String 브랜드_H_ID;
    private String 브랜드_I_ID;
    ExtractableResponse<Response> 브랜드_A;
    ExtractableResponse<Response> 브랜드_B;
    ExtractableResponse<Response> 브랜드_C;
    ExtractableResponse<Response> 브랜드_D;
    ExtractableResponse<Response> 브랜드_E;
    ExtractableResponse<Response> 브랜드_F;
    ExtractableResponse<Response> 브랜드_G;
    ExtractableResponse<Response> 브랜드_H;
    ExtractableResponse<Response> 브랜드_I;
    ...
    private void 샘플_데이터_생성() {
        // 브랜드 생성
        브랜드_A = 브랜드_생성_요청(브랜드_A_명);
        브랜드_B = 브랜드_생성_요청(브랜드_B_명);
        브랜드_C = 브랜드_생성_요청(브랜드_C_명);
        브랜드_D = 브랜드_생성_요청(브랜드_D_명);
        브랜드_E = 브랜드_생성_요청(브랜드_E_명);
        브랜드_F = 브랜드_생성_요청(브랜드_F_명);
        브랜드_G = 브랜드_생성_요청(브랜드_G_명);
        브랜드_H = 브랜드_생성_요청(브랜드_H_명);
        브랜드_I = 브랜드_생성_요청(브랜드_I_명);

        브랜드_A_ID = 브랜드_A.body().jsonPath().getString("id");
        브랜드_B_ID = 브랜드_B.body().jsonPath().getString("id");
        브랜드_C_ID = 브랜드_C.body().jsonPath().getString("id");
        브랜드_D_ID = 브랜드_D.body().jsonPath().getString("id");
        브랜드_E_ID = 브랜드_E.body().jsonPath().getString("id");
        브랜드_F_ID = 브랜드_F.body().jsonPath().getString("id");
        브랜드_G_ID = 브랜드_G.body().jsonPath().getString("id");
        브랜드_H_ID = 브랜드_H.body().jsonPath().getString("id");
        브랜드_I_ID = 브랜드_I.body().jsonPath().getString("id");
    ...
    void findLowestBrandPrices() {
        ...
        assertThat(brandName).isEqualTo(브랜드_D_명);
    ...
    void findLowestPricesBrandMix() {
        ...
        assertThat(categories.get(0)).containsEntry("brandName", 브랜드_C_명);
        assertThat(categories.get(1)).containsEntry("brandName", 브랜드_E_명);
        assertThat(categories.get(2)).containsEntry("brandName", 브랜드_D_명);
        assertThat(categories.get(3)).containsEntry("brandName", 브랜드_G_명);
        assertThat(categories.get(4)).containsEntry("brandName", 브랜드_A_명);
        assertThat(categories.get(5)).containsEntry("brandName", 브랜드_D_명);
        assertThat(categories.get(6)).containsEntry("brandName", 브랜드_I_명);
        assertThat(categories.get(7)).containsEntry("brandName", 브랜드_F_명);
    ...
    void findLowestAndHighestBrandPrices() {
        ...
        assertThat(lowestPrice.getFirst()).containsEntry("brandName", 브랜드_C_명);
        assertThat(lowestPrice.getFirst()).containsEntry("price", "10,000");

        assertThat(highestPrice.getFirst()).containsEntry("brandName", 브랜드_I_명);
        assertThat(highestPrice.getFirst()).containsEntry("price", "11,400");
    }

    @Test
    @DisplayName("특정 카테고리의 최저가 및 최고가 상품이 추가 되어도 알맞은 상품을 조회할 수 있다.")
    void findLowestAndHighestBrandPricesWhenAddItem() {
        // given
        final String 신규_상품_최저가 = "500";
        상품_생성_요청(브랜드_G_ID, Category.TOP.getKorean(), 신규_상품_최저가);
        // when
        ExtractableResponse<Response> 카테고리별_최고가_및_최저가_브랜드_조회_응답 = 카테고리별_최고가_및_최저가_브랜드_조회_요청(Category.TOP.getKorean());
        ...
        assertThat(lowestPrice.getFirst()).containsEntry("brandName", 브랜드_G_명);
        assertThat(lowestPrice.getFirst()).containsEntry("price", 신규_상품_최저가);
